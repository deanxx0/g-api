...
import { InspectionRecipe, InspectionRecipeSchema } from './schema/inspection-recipe.schema';
...
@Module({
  imports: [
    MongooseModule.forFeature([{ name: InspectionRecipe.name, schema: InspectionRecipeSchema }]),
  ],
